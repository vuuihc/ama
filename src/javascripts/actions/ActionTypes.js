 ...
 */
 export const WX_CONFIG_SUCCESS  = 'WX_CONFIG_SUCCESS'
...
export const HOT_QUESTION_LIST_COMPLETED  = 'HOT_QUESTION_LIST_COMPLETED'
...
export const RECEIVE_PRISE_QUESTION = 'RECEIVE_PRISE_QUESTION'
export const RECEIVE_CANCEL_PRISE_QUESTION = 'RECEIVE_CANCEL_PRISE_QUESTION'
export const RECEIVE_PAID = 'RECEIVE_PAID'
...
/*********搜索**********/
export const REQUEST_HISTORY_SEARCH = 'REQUEST_HISTORY_SEARCH'
...
export const REQUEST_SEARCH_QUESTION = 'REQUEST_SEARCH_QUESTION'
export const REQUEST_SEARCH_TUTOR = 'REQUEST_SEARCH_TUTOR'
...
//获取我问的问题列表
export const CLEAR_I_ASKED = 'CLEAR_I_ASKED';
